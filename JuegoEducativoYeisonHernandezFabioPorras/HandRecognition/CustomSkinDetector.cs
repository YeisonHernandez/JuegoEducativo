...
{
    public class CustomSkinDetector : ColorSkinDetector
    {
        public override Image<Gray, byte> Detectar_piel(Image<Bgr, byte> Img, IColor min, IColor max)
        {
            ...
            CvInvoke.Erode(skin, skin, rect_6, 1);
